    ...
    <>
      ...
      <AuroraBackground intensity="subtle" className="wave-divider">
        <section className="container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Heading */}
            <h1 className="text-4xl md:text-6xl font-bold text-claude-text mb-6 text-balance">
              Claude Code Community
              <span className="block text-claude-coral">Helsinki</span>
            </h1>

            {/* Value Proposition */}
            <p className="text-xl md:text-2xl text-claude-text/70 mb-4 font-medium">
              Connect. Build. Share.
            </p>
            <p className="text-lg text-claude-text/60 max-w-2xl mx-auto mb-12">
      ...
      <section className="bg-white/50 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-claude-text text-center mb-12">
              What We Do
            </h2>
